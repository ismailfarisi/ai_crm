              ...
              items.map((item, index) => {
                if (item.type === 'section') {
                  return (
                    <tr
                      key={item.id}
                      className="bg-surface-muted/70 hover:bg-surface-muted transition-colors font-semibold"
                    >
                        ...
                        {readOnly ? (
                          ...
                          <div className="flex items-center gap-2">
                            <input
                              ...
                              className="w-full rounded-md border border-transparent bg-transparent px-2.5 py-1 text-sm font-semibold text-ink placeholder:text-ink-subtle hover:border-border focus:border-brand focus:bg-surface focus:outline-hidden"
                            />
                          </div>
                        )}
                      </td>
                      {!readOnly && (
                        <td className="px-3 py-2 text-center">
                          <button
                            ...
                            className="rounded-md p-1 text-ink-subtle transition-colors hover:bg-danger-soft hover:text-danger"
                ...
                if (item.type === 'note') {
                  return (
                    <tr
                      key={item.id}
                      className="bg-surface/60 hover:bg-surface-muted/40 transition-colors italic"
                    >
                      <td className="px-3 py-2.5 text-center text-ink-subtle">
                        ...
                        {readOnly ? (
                          ...
                          <div className="flex items-center gap-2">
                            <input
                              ...
                              className="w-full rounded-md border border-transparent bg-transparent px-2.5 py-1 text-sm italic text-ink placeholder:text-ink-subtle hover:border-border focus:border-brand focus:bg-surface focus:outline-hidden"
                            />
                          </div>
                        )}
                      </td>
                    ...
                    <td className="px-3 py-2">
                      {readOnly ? (
                        ...
                        <input
                          ...
                          className="w-full rounded-md border border-border/60 bg-surface px-2.5 py-1.5 text-sm text-ink placeholder:text-ink-subtle focus:border-brand focus:ring-1 focus:ring-brand focus:outline-hidden"
                        />
                      )}
                    </td>
                    ...
                    <td className="px-3 py-2 text-right">
                      {readOnly ? (
                        ...
                        <input
                          ...
                          className="w-20 rounded-md border border-border/60 bg-surface px-2 py-1.5 text-right text-sm tabular-nums text-ink focus:border-brand focus:ring-1 focus:ring-brand focus:outline-hidden"
                        />
                      )}
                    </td>
                    ...
                    <td className="px-3 py-2">
                      {readOnly ? (
                        ...
                        <select
                          ...
                          className="w-full rounded-md border border-border/60 bg-surface px-2 py-1.5 text-xs text-ink focus:border-brand focus:ring-1 focus:ring-brand focus:outline-hidden"
                        >
                          {UOM_OPTIONS.map((opt) => (
                    ...
                    <td className="px-3 py-2 text-right">
                      {readOnly ? (
                        ...
                        <input
                          ...
                          className="w-28 rounded-md border border-border/60 bg-surface px-2 py-1.5 text-right text-sm tabular-nums text-ink focus:border-brand focus:ring-1 focus:ring-brand focus:outline-hidden"
                        />
                      )}
                    </td>
                      ...
                      {readOnly ? (
                        ...
                        <div className="relative inline-block w-20">
                          <input
                            ...
                            className="w-full rounded-md border border-border/60 bg-surface pr-5 pl-2 py-1.5 text-right text-sm tabular-nums text-ink focus:border-brand focus:ring-1 focus:ring-brand focus:outline-hidden"
                          />
                    ...
                    {!readOnly && (
                      <td className="px-3 py-2 text-center">
                        <button
                          type="button"
                          onClick={() => handleRemoveItem(item.id)}
                          className="rounded-md p-1.5 text-ink-subtle opacity-60 group-hover:opacity-100 transition-all hover:bg-danger-soft hover:text-danger"
